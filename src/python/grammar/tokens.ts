// @ts-nocheck -- vendored Lezer tokenizer paired with trellis-parser.ts.
...
const bracketed = new Set([
  ParenthesizedExpression, TupleExpression, ComprehensionExpression, tupleTarget, listTarget,
