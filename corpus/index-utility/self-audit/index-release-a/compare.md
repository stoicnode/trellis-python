...
Index unchanged while 31 raw metric values and 0 numeric persistent-finding facts changed; integer rounding or saturated terms can hide movement.

| dimension | exact points before | exact points after | exact delta | integer points before → after |
| --- | ---: | ---: | ---: | ---: |
| complexity-erosion | 25.843260301 | 25.494960301 | -0.3483 | 26 → 25 |
| duplication | 9.761483632 | 9.894783052 | +0.133299419 | 9 → 10 |
| import-cycle | 2.77666405 | 2.75176405 | -0.0249 | 3 → 3 |

Changed density denominators (10):
- duplication.candidate.density.production: 0/19002 → 26/19587
- duplication.candidate.density.test: 1370/23687 → 1370/23791
- duplication.density.production: 965/30649 → 995/31646
- duplication.density.test: 3573/33575 → 3573/33732
- duplication.duplicated-lines.production: 965/30649 → 995/31646
...
## Metric deltas (31 changed of 70)

| metric | baseline | current | delta |
| --- | --- | --- | --- |
| complexity.executable-sloc.production | 30649 | 31646 | +997 |
| complexity.executable-sloc.test | 33575 | 33732 | +157 |
| complexity.functions.production | 2339 | 2465 | +126 |
| complexity.functions.test | 3879 | 3905 | +26 |
| documentation.blocks.production | 2346 | 2355 | +9 |
| duplication.candidate.covered-lines.production | 0 | 26 | +26 |
| duplication.candidate.density.production | 0 | 0.0013 | +0.0013 |
| duplication.candidate.density.test | 0.0578 | 0.0576 | -0.0003 |
| duplication.candidate.eligible-lines.production | 19002 | 19587 | +585 |
| duplication.candidate.eligible-lines.test | 23687 | 23791 | +104 |
| … | | | +21 more |

## Findings

148 new · 141 resolved · 171 persistent
